...
htmlhelp_basename = 'NethMonitordoc'
...
latex_documents = [
  ('index', 'NethMonitor.tex', u'Documentazione NethMonitor',
   u'Nethesis', 'manual'),
]
...
man_pages = [
    ('index', 'nethmonitor', u'Documentazione NethMonitor',
     [u'Nethesis'], 1)
]
